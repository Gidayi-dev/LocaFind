...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      (!formData.businessName || !formData.businessType || !formData.businessAddress)
    ) {
      setError('Business name, type, and address are required for vendors');
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      // Store token and user data (for testing only)
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-[#D3DAD9]">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Email */}
              <div>
                <label className="block text-sm font-medium text-[#37353E] mb-2">Email Address</label>
                <input
                  type="email"
                  name="email"
              ...
              {/* Phone */}
              <div>
                <label className="block text-sm font-medium text-[#37353E] mb-2">Phone Number</label>
                <input
                  type="tel"
                  name="phone"
              ...
              {/* Role Selection */}
              <div>
                <label className="block text-sm font-medium text-[#37353E] mb-2">Account Type</label>
                  ...
                  {['user', 'vendor'].map((role) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="font-medium text-[#37353E]">
                          {role === 'user' ? 'Regular User' : 'Business Owner'}
                        </div>
              ...
              {formData.role === 'vendor' && (
                <div className="space-y-4 p-4 bg-[#D3DAD9] rounded-lg border border-[#715A5A]">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#37353E] mb-2">Business Name *</label>
                    <input
                      type="text"
                      name="businessName"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#37353E] mb-2">Business Type *</label>
                    <select
                      name="businessType"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#37353E] mb-2">Business Address *</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#37353E] mb-2">Business Description</label>
                    <textarea
              ...
              {/* Password */}
              <div>
                <label className="block text-sm font-medium text-[#37353E] mb-2">Password</label>
                <input
                  type="password"
                  name="password"
              ...
              <div>
                <label className="block text-sm font-medium text-[#37353E] mb-2">Confirm Password</label>
                <input
                  type="password"
