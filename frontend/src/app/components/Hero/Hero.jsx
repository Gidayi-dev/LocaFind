...
const HeroSection = () => {
  ...
  return (
    <section className="bg-[#D3DAD9] min-h-screen">
      {/* Main Hero Area - Above the Fold */}
      <div className="container mx-auto px-4 pt-24 pb-16">
        <div className="max-w-4xl mx-auto text-center mb-16">
          {/* Main Headline */}
          <div className="mb-12">
            <h1 className="text-5xl lg:text-6xl font-bold text-[#37353E] mb-6 leading-tight">
              Find Local Businesses
              <span className="block text-[#715A5A]">Around You</span>
            </h1>
            <p className="text-xl text-[#44444E] mb-8 leading-relaxed">
              Discover verified shops, services, and essentials in your neighborhood. 
              Community-powered and always free.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 max-w-md mx-auto shadow-lg">
            <div className="grid grid-cols-3 gap-6 text-center">
              <div>
                <div className="text-2xl font-bold text-[#37353E]">1,247</div>
                <div className="text-sm text-[#44444E]">Verified</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-[#37353E]">89</div>
                <div className="text-sm text-[#44444E]">Active Now</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-[#37353E]">+23</div>
                <div className="text-sm text-[#44444E]">New Today</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="text-center pb-8">
        <div className="animate-bounce">
          <svg className="w-6 h-6 text-[#715A5A] mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
